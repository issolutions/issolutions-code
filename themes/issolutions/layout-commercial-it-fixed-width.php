<?php
/**
 * Template Name: CommIT Fixed Width
 *
 * @package WallPress
...
<div class="page-header"><?php the_title(); ?></div>
		...
		<div id="container" class="clearfix">
			...
			<div id="content" style="background:#1d6a98; padding:0px;">
			  ...
			  <div class="main-post" style="margin-right: 0px;">
				  <div style="width:100%; max-width:400px; float: left;">
						<div style="color:#ffffff; font-family: 'Cuprum', Arial, sans-serif; font-size: 32px; font-weight:bold; margin: 10px;">Contact A Representative
						</div>
				  </div>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(308),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(318),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(343),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content" style="background:#1d6a98; padding:0px;">
				...
				<div class="main-post" style="margin-right: 0px;">
					...
					<a href="../contact-iss/employers/">
						<div style="width:100%; max-width:270px; float: right; background:#278fcc; padding:10px; color:#ffffff; font-family: 'Cuprum', Arial, sans-serif; font-size: 32px; font-weight:bold;">Sign Up Now >
						</div>
					</a>
