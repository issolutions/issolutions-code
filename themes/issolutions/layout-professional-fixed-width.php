<?php
/**
 * Template Name: Professional Fixed Width
 *
 * @package WallPress
...
<div class="page-header"><?php the_title(); ?></div>
		...
		<div id="content" style="background:#1d6a98; padding:0px;">
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(249),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(252),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(262),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(265),  'orderby' => 'post__in' ) ); ?>
