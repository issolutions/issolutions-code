<?php
/**
 * Template Name: CommEngineer Fixed Width
 *
 * @package WallPress
...
<div class="page-header"><?php the_title(); ?></div>
		...
		<div id="content" style="background:#1d6a98; padding:0px;">
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(368),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(372),  'orderby' => 'post__in' ) ); ?>
			...
			<div id="content">
			<?php query_posts( array( 'post__in' => array(376),  'orderby' => 'post__in' ) ); ?>
